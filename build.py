...
ICONS = {
    ...
    # « handshake » ne dessine pas une poignée de main mais deux anneaux enlacés.
    # Une poignée de main demande quatre traits presque horizontaux : à 20 px —
    # la taille du méga-menu, où « Nos partenaires » l'emploie — elle redevient
    # un ruban ondulé, quelle que soit la façon de la tracer. Les anneaux disent
