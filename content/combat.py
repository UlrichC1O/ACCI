# -*- coding: utf-8 -*-
"""Pages 9 à 20 — Nos champs d’action face aux mauvaises pratiques."""

SEC = "Nos champs d’action"

PAGES = [

# 9 — NOS CHAMPS D’ACTION (vue d’ensemble) -----------------------------------------
{
  "slug": "notre-combat",
  "title": "Notre action",
  ...
  "blocks": [
    {"type": "hero", "variant": "default",
     ...
     "kicker": "Notre action",
     "title": "Répondre aux **dérives**, pour un numérique qui élève",
     "subtitle": "Les réseaux sociaux sont une chance pour la Côte d’Ivoire. Sans vigilance, ils peuvent aussi devenir un espace de désinformation, de violences et d’escroqueries. Voici les domaines où l’ACCI agit.",
    ...
    {"type": "section", "align": "center", "title": "Des écrans aux conséquences réelles",
     "lead": "Derrière chaque publication malveillante, il y a des personnes : une réputation abîmée, une famille trompée, un adolescent harcelé, une communauté divisée. Notre action est d’abord humaine."},

    {"type": "cards", "columns": 4, "title": "Les domaines de notre action",
     "items": [
       {"icon": "fact", "title": "Désinformation", "text": "Prévenir la diffusion des fausses informations.", "href": "desinformation"},
       {"icon": "shield", "title": "Cyberharcèlement", "text": "Prévenir les violences en ligne.", "href": "cyberharcelement"},
       {"icon": "money", "title": "Arnaques en ligne", "text": "Protéger le public des escroqueries.", "href": "cyber-escroquerie"},
       {"icon": "scale", "title": "Diffamation", "text": "Préserver la dignité et la réputation.", "href": "diffamation"},
       {"icon": "warning", "title": "Discours de haine", "text": "Prévenir l’incitation et la division.", "href": "discours-haine"},
       {"icon": "child", "title": "Protection des mineurs", "text": "Sécuriser l’expérience des plus jeunes.", "href": "protection-mineurs"},
       {"icon": "lock", "title": "Sextorsion", "text": "Répondre au chantage à l’intime.", "href": "sextorsion"},
    ...
    {"type": "split", "icon": "scale",
     ...
     "text": [
       "La réponse ne peut être seulement répressive. Notre action repose sur trois leviers complémentaires.",
    ...
    {"type": "stats", "items": [
      {"value": "7", "label": "Internautes sur 10 exposés à de fausses informations"},
    ...
    {"type": "chart", "kind": "donut", "narrow": True,
     "kicker": "Ce qui nous est signalé",
    ...
    {"type": "cta", "title": "Cette action est aussi la vôtre",
...
# 10 — MAUVAISES PRATIQUES (panorama) ---------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "compact",
     "kicker": "Panorama",
     "title": "Les mauvaises pratiques sur les réseaux sociaux",
     "subtitle": "Comprendre les dérives pour mieux y répondre. Tour d’horizon des comportements qui fragilisent l’espace numérique ivoirien."},
    ...
    {"type": "section", "title": "Quand l’outil se retourne contre l’humain",
     ...
     "body": [
       ...
       "En Côte d’Ivoire comme ailleurs, certaines pratiques se sont banalisées au point de paraître normales. Elles ne le sont pas. Les nommer avec précision, c’est déjà commencer à y remédier.",
     ]},

    {"type": "checklist", "variant": "bad", "columns": 2, "title": "Les pratiques que nous documentons",
     "items": [
    ...
    {"type": "cards", "columns": 4, "title": "Explorer chaque dérive",
     "items": [
       ...
       {"icon": "eye", "title": "Contenus explicites", "href": "contenus-explicites", "text": "Nudité et images sensibles."},
    ...
    {"type": "cta", "title": "Face à une mauvaise pratique, signalez",
...
# 11 — DÉSINFORMATION -------------------------------------------------------
{
  ...
  "section": SEC,
  "description": "La désinformation et les fausses nouvelles en Côte d’Ivoire : comprendre, repérer et éviter de relayer les fausses informations.",
  "blocks": [
    {"type": "hero", "variant": "compact",
     "kicker": "Priorité n°1",
     "title": "Désinformation & fausses nouvelles",
     "subtitle": "La fausse information se propage six fois plus vite que la vraie. Apprendre à la repérer est devenu un réflexe essentiel."},
    ...
    {"type": "callout", "variant": "danger", "title": "Des conséquences graves",
     "text": ["La désinformation peut provoquer des mouvements de panique, nuire à la santé publique, alimenter les tensions communautaires, porter atteinte à des réputations et fragiliser la confiance dans les institutions et les médias."]},
    ...
    {"type": "steps", "title": "Les bons réflexes avant de partager",
     "items": [
       {"title": "Marquer une pause", "text": "Si une information provoque une réaction très forte, c’est le moment de prendre du recul."},
       ...
       {"title": "Ne pas partager le doute", "text": "Dans le doute, on s’abstient. Partager une fausse information, c’est contribuer à sa diffusion."},
     ]},
    ...
    {"type": "split", "icon": "fact", "reverse": True,
     ...
     "text": [
       ...
       "Nous formons à la vérification des faits (fact-checking) et travaillons avec les médias pour démentir rapidement les rumeurs les plus préjudiciables.",
     ],
     "cta": {"label": "Apprendre à vérifier l’information", "href": "verification-information"}},

    {"type": "cta", "title": "Devenez un relais d’information fiable",
...
# 12 — CYBERHARCÈLEMENT -----------------------------------------------------
{
  ...
  "section": SEC,
  "description": "Comprendre et prévenir le cyberharcèlement en Côte d’Ivoire : formes, conséquences et recours possibles.",
  "blocks": [
    {"type": "hero", "variant": "compact",
     "kicker": "Violence en ligne",
     "title": "Le cyberharcèlement",
     "subtitle": "Des propos qui blessent, des attaques répétées. Le harcèlement en ligne a des conséquences réelles sur la santé et le quotidien des personnes visées."},
    ...
    {"type": "section", "title": "Qu’est-ce que le cyberharcèlement ?",
     ...
     "body": [
       ...
       "Sa particularité est qu’il atteint la personne partout et à toute heure, et que les contenus peuvent être vus et partagés par un très grand nombre d’internautes. La personne visée se retrouve sans répit.",
     ]},

    {"type": "checklist", "variant": "bad", "columns": 2, "title": "Les formes du cyberharcèlement",
     "items": [
    ...
    {"type": "callout", "variant": "danger", "title": "Des effets durables",
     "text": ["Anxiété, dépression, isolement, décrochage scolaire, atteinte à l’image et, dans les cas les plus graves, idées suicidaires. Le cyberharcèlement n’a rien d’anodin : ses effets s’inscrivent dans la durée."]},

    {"type": "steps", "title": "Que faire si vous êtes victime ?",
     "items": [
       {"title": "Ne pas entrer dans l’échange", "text": "Répondre alimente souvent l’escalade. Il est préférable de ne pas réagir."},
       ...
       {"title": "En parler", "text": "Vous n’avez pas à rester seul(e) : parlez-en à un proche, à un adulte de confiance ou à notre cellule d’écoute."},
    ...
    {"type": "split", "icon": "heart", "reverse": True,
     ...
     "text": [
       ...
       "Et si vous êtes témoin ? Votre soutien compte : accompagnez la personne visée, signalez les contenus, ne les relayez pas.",
     ],
...
# 13 — CYBER-ESCROQUERIE ----------------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "section", "title": "L’arnaque en ligne, un phénomène coûteux",
     "lead": "Les escroqueries numériques font des milliers de victimes et fragilisent la confiance dans l’économie en ligne.",
     "body": [
       "Profitant de l’attrait de l’argent facile et de la confiance des internautes, des réseaux organisés opèrent sur les réseaux sociaux et les applications de messagerie. Ils se font passer pour des proches, des entreprises, des célébrités ou des institutions.",
    ...
    {"type": "steps", "title": "Comment vous protéger",
     "items": [
       {"title": "Se méfier de l’urgence", "text": "Les escrocs créent un sentiment de pression pour empêcher toute réflexion."},
       {"title": "Vérifier l’identité", "text": "Confirmer par un autre canal qu’il s’agit bien de la personne ou de l’entreprise annoncée."},
       {"title": "Ne jamais communiquer ses codes", "text": "Aucun service sérieux ne demande votre mot de passe ou votre code de transaction."},
       {"title": "Ne pas payer d’avance", "text": "Des frais à régler pour « débloquer » un gain ou une opportunité sont un signal d’alerte."},
       {"title": "Signaler", "text": "Alerter la plateforme, ses proches et, le cas échéant, les autorités compétentes."},
     ]},
...
# 14 — DIFFAMATION ----------------------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "compact",
     ...
     "title": "Diffamation & atteinte à la dignité",
     "subtitle": "Porter atteinte à une réputation en un clic est facile ; réparer le tort causé l’est beaucoup moins. La parole en ligne engage."},
...
# 15 — DISCOURS DE HAINE ----------------------------------------------------
{
  ...
  "section": SEC,
  "description": "Le discours de haine en ligne : propos tribaux, religieux et discriminatoires. Pourquoi et comment l’ACCI y répond.",
  "blocks": [
    {"type": "hero", "variant": "compact",
     "kicker": "Cohésion sociale",
     "title": "Le discours de haine",
     "subtitle": "Les propos qui divisent fragilisent la cohésion sociale. Dans un pays riche de sa diversité, refuser la haine en ligne est une responsabilité collective."},
    ...
    {"type": "section", "title": "Comprendre le discours de haine",
     ...
     "body": [
       ...
       "Particulièrement sensible en période de tensions, le discours de haine peut conduire à la discrimination, à l’hostilité, voire à la violence. Il fragilise le vivre-ensemble.",
     ]},
    ...
    {"type": "checklist", "variant": "good", "columns": 2, "title": "Notre engagement pour le respect",
     "items": [
    ...
    {"type": "quote",
     "text": "La diversité de la Côte d’Ivoire est une richesse à préserver et à célébrer.",
     "author": "ACCI"},
...
# 16 — PROTECTION DES MINEURS -----------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "split", "image": "protection-enfants.jpg",
     ...
     "text": [
       "La protection la plus efficace passe par l’accompagnement plutôt que par l’interdiction. Un enfant à qui l’on explique les risques et qui sait qu’il peut se confier est bien mieux préparé.",
       "Parents, enseignants et créateurs ont chacun un rôle à jouer pour faire d’internet un espace d’épanouissement plutôt que d’exposition.",
     ],
     "bullets": [
    ...
    {"type": "callout", "variant": "warning", "title": "Créateurs, une vigilance accrue",
     "text": ["Filmer ou exposer des enfants, même les siens, comporte des risques. Préservez leur image, leur intimité et leur droit à décider plus tard de leur présence en ligne."]},
...
# 17 — CONTENUS EXPLICITES --------------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "callout", "variant": "danger", "title": "Une interdiction sans exception",
     "text": ["La diffusion d’images intimes sans consentement et tout contenu impliquant des mineurs constituent des infractions pénales, que l’ACCI condamne sans réserve et que la loi réprime. Voir aussi notre page sur le chantage et la sextorsion."]},
...
# 18 — SEXTORSION -----------------------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "compact",
     "kicker": "Alerte",
     "title": "Chantage & sextorsion",
     "subtitle": "Un phénomène en progression, qui exploite l’intimité pour obtenir de l’argent ou des faveurs. Personne ne devrait y faire face seul."},
    ...
    {"type": "section", "title": "Comprendre la sextorsion",
     ...
     "body": [
       ...
       "Par honte ou par peur, les personnes visées n’osent souvent pas en parler. C’est précisément ce silence que les auteurs de ce chantage exploitent.",
     ]},

    {"type": "callout", "variant": "danger", "title": "Si vous êtes victime : ne payez pas",
     "text": ["Payer n’arrête presque jamais le chantage et conduit le plus souvent à de nouvelles demandes. Coupez le contact, conservez les preuves et demandez de l’aide sans attendre."]},

    {"type": "steps", "title": "Comment réagir",
     "items": [
       {"title": "Ne pas céder au chantage", "text": "Ne rien payer et n’envoyer aucun contenu supplémentaire."},
       {"title": "Conserver les preuves", "text": "Captures d’écran des menaces, du profil et des échanges."},
       {"title": "Bloquer et signaler", "text": "Bloquer l’auteur et signaler le compte à la plateforme."},
       {"title": "En parler", "text": "Contacter une personne de confiance ou notre cellule d’écoute. Vous n’êtes pas responsable."},
       {"title": "Faire valoir ses droits", "text": "La sextorsion est un délit. Notre accompagnement juridique peut vous orienter vers les autorités."},
     ]},
    ...
    {"type": "cta", "title": "Vous êtes concerné(e) ? Nous pouvons vous aider.",
...
# 19 — VIE PRIVÉE -----------------------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "callout", "variant": "warning", "title": "Le consentement, toujours",
     "text": ["Publier la photo ou les informations d’une autre personne sans son accord est une atteinte à sa vie privée. Demandez toujours la permission, en particulier lorsqu’il s’agit d’enfants."]},
...
# 20 — DÉFIS DANGEREUX ------------------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "compact",
     ...
     "subtitle": "Certains challenges exposent leurs participants à des risques réels. L’audience ne justifie jamais une mise en danger."},
    ...
    {"type": "section", "title": "Quand le challenge devient piège",
     ...
     "body": [
       ...
       "Les algorithmes valorisent l’extrême, et la pression du groupe fait le reste. Les conséquences vont de blessures graves à des décès.",
     ]},

    {"type": "callout", "variant": "danger", "title": "Aucune vue ne vaut une vie",
     "text": ["Un défi qui met en danger votre intégrité ou celle d’autrui n’est pas un divertissement : c’est un risque réel. Refuser d’y participer et de le relayer, c’est faire preuve de discernement."]},
    ...
    {"type": "split", "icon": "lightbulb", "reverse": True,
     ...
     "text": [
       "L’enjeu n’est pas d’interdire les challenges, mais de réorienter cette énergie créative vers des contenus positifs.",
