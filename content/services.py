...
# 29 — SERVICES -------------------------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "default",
     ...
     "title": "Des services concrets pour **accompagner et protéger**",
    ...
    {"type": "cards", "columns": 3, "title": "Nos principaux services",
     "items": [
       ...
       {"icon": "alert", "title": "Signaler un abus", "text": "Un point de contact pour signaler les contenus préjudiciables.", "href": "signaler-abus", "tag": "Agir"},
       {"icon": "heart", "title": "Cellule d’écoute", "text": "Un soutien confidentiel pour les personnes touchées par une dérive en ligne.", "href": "cellule-ecoute", "tag": "Soutenir"},
    ...
    {"type": "split", "icon": "shield", "reverse": True,
     "kicker": "Un accompagnement de bout en bout", "title": "De la prévention à l’accompagnement",
     "text": [
       "Nos services couvrent l’ensemble du parcours : prévenir par la formation, répondre par le signalement, soutenir par l’écoute et orienter par l’accompagnement juridique.",
       "Que vous soyez créateur, parent, personne concernée ou simple internaute, l’ACCI propose une réponse adaptée à votre situation.",
     ],
...
# 30 — ADHÉSION -------------------------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "default",
     ...
     "subtitle": "Rejoignez une communauté de créateurs engagés pour un numérique plus responsable et bénéficiez d’un accompagnement dédié.",
    ...
    {"type": "table", "title": "Catégories de membres",
     ...
     "rows": [
       ["Membre adhérent", "Tout créateur ou internaute soutenant nos objectifs", "Signer la charte"],
    ...
    {"type": "cta", "title": "Prêt(e) à nous rejoindre ?",
     "text": "Quelques minutes suffisent pour formaliser votre adhésion.",
     "buttons": [
...
# 31 — FORMATIONS -----------------------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "cards", "columns": 3, "title": "Nos programmes",
     "items": [
       {"icon": "fact", "title": "Esprit critique & info", "text": "Apprendre à vérifier l’information et à reconnaître la désinformation."},
    ...
    {"type": "cta", "title": "Développez vos compétences",
...
# 32 — ACCOMPAGNEMENT JURIDIQUE ---------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "compact",
     ...
     "title": "Accompagnement juridique",
     "subtitle": "Face à une atteinte subie en ligne, vous disposez de droits. Nous vous aidons à les comprendre et à les faire valoir."},

    {"type": "section", "title": "Une orientation accessible",
     "lead": "L’ACCI informe et oriente les créateurs et les personnes concernées sur les démarches possibles.",
     "body": [
    ...
    {"type": "cards", "columns": 3, "title": "Nous pouvons vous aider sur",
     "items": [
       ...
       {"icon": "shield", "title": "Harcèlement en ligne", "text": "Les démarches pour faire cesser une situation de harcèlement."},
    ...
    {"type": "callout", "variant": "warning", "title": "Information et orientation",
...
# 33 — SIGNALER UN ABUS -----------------------------------------------------
{
  ...
  "blocks": [
    {"type": "hero", "variant": "compact",
     "kicker": "Signalement",
     "title": "Signaler un abus",
     "subtitle": "Un contenu vous choque, vous blesse ou met une personne en danger ? Le signalement est un geste citoyen qui protège les autres."},

    {"type": "section", "title": "Pourquoi signaler ?",
     "lead": "Signaler contribue à limiter la diffusion des contenus préjudiciables et à documenter les situations.",
     "body": [
       "Chaque signalement compte : il informe les plateformes, documente les faits et contribue à protéger d’autres personnes.",
    ...
    {"type": "steps", "title": "Comment signaler efficacement",
     "items": [
       {"title": "Conserver les preuves", "text": "Réalisez des captures d’écran datées du contenu concerné avant qu’il ne soit retiré."},
       {"title": "Signaler à la plateforme", "text": "Utilisez les outils de signalement intégrés au réseau social concerné."},
       {"title": "Nous informer", "text": "Transmettez-nous la situation via le formulaire de contact pour être orienté(e)."},
       {"title": "Accompagner la personne", "text": "Si une personne est en danger, soutenez-la et orientez-la vers la cellule d’écoute."},
     ]},

    {"type": "cards", "columns": 3, "title": "Que signaler ?",
     "items": [
       {"icon": "shield", "title": "Harcèlement", "text": "Propos ou comportements répétés visant une personne."},
       ...
       {"icon": "child", "title": "Mise en danger de mineurs", "text": "Tout contenu portant atteinte à la sécurité des enfants."},
       {"icon": "fact", "title": "Fausses informations", "text": "Désinformation diffusée à grande échelle."},
     ]},

    {"type": "callout", "variant": "danger", "title": "Urgence et danger immédiat",
     "text": ["Si une personne est en danger immédiat, nous vous invitons à contacter sans délai les services d’urgence et les autorités compétentes. Le signalement à l’ACCI ne remplace pas une intervention d’urgence."]},

    {"type": "cta", "title": "Transmettre un signalement",
     "buttons": [
...
# 34 — CELLULE D’ÉCOUTE -----------------------------------------------------
{
  ...
  "section": SEC,
  "description": "La cellule d’écoute de l’ACCI : un soutien confidentiel et bienveillant pour les personnes touchées par une dérive en ligne.",
  "blocks": [
    {"type": "hero", "variant": "compact",
    ...
    {"type": "section", "title": "Une écoute attentive et un premier appui",
     "lead": "Être confronté(e) à une dérive en ligne est une épreuve. Personne ne devrait la traverser seul.",
     "body": [
       "La cellule d’écoute de l’ACCI accueille les personnes concernées et leurs proches, les écoute avec bienveillance et les oriente vers les ressources adaptées : soutien psychologique, accompagnement juridique, signalement.",
       "La confidentialité et le respect de la personne sont au cœur de notre démarche. Vous n’êtes jamais jugé(e), jamais tenu(e) pour responsable.",
     ]},
    ...
    {"type": "cards", "columns": 3, "title": "Ce que nous offrons",
     "items": [
       ...
       {"icon": "users", "title": "Soutien des proches", "text": "Un appui aussi pour les proches et l’entourage."},
    ...
    {"type": "callout", "variant": "success", "title": "Le premier pas, c’est en parler",
     "text": ["En parler est souvent le geste le plus difficile, et le plus libérateur. Contactez-nous : nous sommes là pour vous accompagner."]},
...
# 35 — ESPACE PRESSE --------------------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "cards", "columns": 3, "title": "Ressources pour les médias",
     "items": [
       {"icon": "bullhorn", "title": "Communiqués", "text": "Nos communications officielles.", "href": "communiques"},
  ...
  "blocks": [
    ...
    {"type": "downloads", "title": "Guides pratiques",
     "items": [
       ...
       {"title": "Vérifier l’information en 5 étapes", "text": "Le mémo à garder sous la main au quotidien.", "meta": "PDF"},
       ...
       {"title": "Comprendre la sextorsion", "text": "Reconnaître la situation et savoir où trouver de l’aide.", "meta": "PDF"},
     ]},
...
# 37 — FAQ ------------------------------------------------------------------
{
  ...
  "blocks": [
    ...
    {"type": "accordion", "title": "À propos de l’association",
     "items": [
       {"q": "Qu’est-ce que l’ACCI ?", "a": ["L’ACCI est l’Association des Créateurs de Contenu Ivoiriens, une organisation à but non lucratif qui promeut un usage responsable des réseaux sociaux et œuvre à réduire les mauvaises pratiques en ligne en Côte d’Ivoire."]},
       {"q": "L’ACCI est-elle un organe de censure ?", "a": ["Non. L’ACCI n’exerce aucune fonction de censure. Son action repose sur l’éducation, la sensibilisation et la responsabilité, dans le respect de la liberté d’expression."]},
    ...
    {"type": "accordion", "title": "Signalement & aide",
     "items": [
       {"q": "Comment signaler un contenu abusif ?", "a": ["Conservez les preuves, signalez le contenu à la plateforme concernée, puis transmettez-nous la situation via notre page Signaler un abus."]},
       {"q": "Je suis victime de harcèlement, que faire ?", "a": ["Vous n’êtes pas seul(e). Il est recommandé de conserver les preuves, de bloquer l’auteur des messages et de contacter notre cellule d’écoute pour être accompagné(e)."]},
  ...
  "blocks": [
    ...
    {"type": "definitions", "title": "De A à Z",
     "items": [
       ...
       {"term": "Hameçonnage (phishing)", "def": "Technique frauduleuse visant à obtenir vos identifiants en se faisant passer pour un service de confiance."},
